...
class AppSettings {
  /// Basic Settings
  static const String applicationName = 'Talab';
  ...
  static final String baseUrl =
      "${HelperUtils.checkHost(testUrl)}api/"; //don't change this
...
it will call API in background without showing the process and when data available it will replace it with new data */
  ...
  ///Native deep link
  //TODO: Change to Demo Url when releasing
  static const String shareNavigationWebUrl = "www.talab.qa";
