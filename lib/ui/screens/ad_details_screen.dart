...
import 'package:Talab/data/model/report_item/reason_model.dart';
...
import 'package:Talab/ui/screens/chat/chat_screen.dart';
import 'package:Talab/ui/screens/google_map_screen.dart';
...
import 'package:Talab/ui/screens/subscription/widget/featured_ads_subscription_plan_item.dart';
...
import 'package:Talab/utils/cloud_state/cloud_state.dart';
...
import 'package:Talab/utils/validator.dart';
...
void launchWhatsApp(String phoneNumber) async {
  ...
  try {
    ...
    HelperUtils.showSnackBarMessage(
        context, "Could not launch WhatsApp", messageDuration: 3);
  }
}
