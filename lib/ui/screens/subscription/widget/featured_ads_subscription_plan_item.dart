...
import 'package:Talab/ui/screens/subscription/payment_gatways.dart';
...
import 'package:Talab/utils/payment/gateaways/payment_webview.dart';
                              ...
                              if (widget.modelList[selectedIndex!].finalPrice! > 0) {
                                if (Platform.isIOS) {
                                  widget.inAppPurchaseManager.buy(
                                    widget.modelList[selectedIndex!].iosProductId!,
                                    widget.modelList[selectedIndex!].id!.toString(),
                                  );
                                } else {
